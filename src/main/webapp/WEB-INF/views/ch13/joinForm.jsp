...
<div class="card">
	...
	<div class="card-body">
	   ...
	   <div class="input-group">
	      ...
	      <input id="mid"  name="mid" type="text" class="form-control" value="${ch13Member.mid}">
	   </div>
	   ...
	   <div class="input-group mt-2">
	      ...
	      <input id="mname" name="mname" type ="text" class="form-control" value="${ch13Member.mname}"></input>
	   </div>
	   
	   
	   <div class="input-group mt-2">
	      <div class="input-group-prepend"><span class="input-group-text">비밀번호</span></div>
	      <input id="mpassword" name="mpassword" type ="password" class="form-control"></input>
	   </div>
	   
	   <div class="input-group mt-2">
	      <div class="input-group-prepend"><span class="input-group-text">이메일</span></div>
	      <input id="memail" name="memail" type ="email" class="form-control" value="${ch13Member.memail}"></input>
	   </div>
