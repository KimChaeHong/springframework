...
<div class="card">
	...
	<div class="card-body">
		<div>
			...
			<!-- /가 없으면 상대경로 이다. getMethod 대신에 getAtag가 들어감 -->
		...
		<hr />
		<div class="mt-2">
			<button onclick="requestGet1()" class="btn btn-info btn-sm mb-2">JavaScript:location.href
				속성 이용</button>
			<br /> <br />
			<button onclick="requestGet2()" class="btn btn-info btn-sm mb-2">JavaScript:Ajax
				이용</button>
			<button onclick="requestGet3()" class="btn btn-info btn-sm mb-2">JavaScript:Ajax
				이용</button>
			<div id="ajaxResult" class="border mt-2">Ajax 결과</div>
			<script>
