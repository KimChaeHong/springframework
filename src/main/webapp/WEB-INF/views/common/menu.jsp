...
<div class="accordion" id="accordionMenu">
	<div class="accordion-item">
		<h2 class="accordion-header">
			<!-- chNum의 값이 ch01이면 true 아니면 false -->
			<button class="accordion-button ${chNum=='ch01'?'':'collapsed'}"
				type="button" data-bs-toggle="collapse" data-bs-target="#ch01"
				aria-expanded="${chNum=='ch01'?true:false}" aria-controls="ch01">
				Ch01. Development Environment (Create MVC Project)</button>
		</h2>
		<div id="ch01"
	...
	<div class="accordion-item">
		<h2 class="accordion-header">
			<button class="accordion-button ${chNum=='ch02'?'':'collapsed'}"
				type="button" data-bs-toggle="collapse" data-bs-target="#ch02"
				aria-expanded="${chNum=='ch02'?true:false}" aria-controls="ch02">
				Ch02. Controller (Request Mapping)</button>
		</h2>
		<div id="ch02"
			...
			<div class="accordion-body">
				<ul>
					...
					<li><a href="${pageContext.request.contextPath}/ch02/mypage">MyPage(로그인
							체크 여부 확인)</a></li>
					<li><a
						href="${pageContext.request.contextPath}/ch02/loginForm">로그인/로그아웃</a></li>
				</ul>
			</div>
		</div>
	</div>
	<div class="accordion-item">
		<h2 class="accordion-header">
			<button class="accordion-button ${chNum=='ch03'?'':'collapsed'}"
				type="button" data-bs-toggle="collapse" data-bs-target="#ch03"
				aria-expanded="${chNum=='ch03'}" aria-controls="ch03">
				Ch03. Controller (Request Parameter)</button>
		</h2>
		<div id="ch03"
				...
				<ul>
					...
					<li><a
						href="${pageContext.request.contextPath}/ch03/postMethodForm">POST
							방식 데이터 얻기</a></li>
					<li><a
						href="${pageContext.request.contextPath}/ch03/defaultValue?param1=문자열&param2=5&param3=3.14&param4=true&param5=2024-08-27">파라미터
							생략 시 디폴트 값 설정</a></li>
					<li><a
						href="${pageContext.request.contextPath}/ch03/otherArgName?param1=문자열&param2=5&param3=3.14&param4=true&param5=2024-08-27">파라미터이름과
							매개변수 이름이 다를 경우</a></li>
					<li><a
						href="${pageContext.request.contextPath}/ch03/commandObject?param1=문자열&param5=2024-08-27">DTO로
							파라미터 값을 모두 받기</a></li>
					<li><a
	...
	<div class="accordion-item">
		<h2 class="accordion-header">
			<button class="accordion-button ${chNum=='ch04'?'':'collapsed'}"
				type="button" data-bs-toggle="collapse" data-bs-target="#ch04"
				aria-expanded="${chNum=='ch04'}" aria-controls="ch04">
				Ch04. Controller (Validation)</button>
		</h2>
		<div id="ch04"
	...
	<div class="accordion-item">
		<h2 class="accordion-header">
			<button class="accordion-button ${chNum=='ch05'?'':'collapsed'}"
				type="button" data-bs-toggle="collapse" data-bs-target="#ch05"
				aria-expanded="${chNum=='ch05'}" aria-controls="ch05">
				Ch05. Controller (Header / Cookie)</button>
		</h2>
		<div id="ch05"
	...
	<div class="accordion-item">
		<h2 class="accordion-header">
			<button class="accordion-button ${chNum=='ch06'?'':'collapsed'}"
				type="button" data-bs-toggle="collapse" data-bs-target="#ch06"
				aria-expanded="${chNum=='ch06'}" aria-controls="ch06">
				Ch06. Controller (Forward / Redirect)</button>
		</h2>
		<div id="ch06"
				...
				<ul>
					...
					<li><a
						href="${pageContext.request.contextPath}/ch06/sessionData">다른
							요청시 세션 데이터 이용</a></li>
					<li><a href="${pageContext.request.contextPath}/ch06/cartview">장바구니
							보기</a></li>
					<li><a
						href="${pageContext.request.contextPath}/ch06/productlist">상품목록</a></li>
				</ul>
			</div>
		</div>
	</div>
	<div class="accordion-item">
		<h2 class="accordion-header">
			<button class="accordion-button ${chNum=='ch07'?'':'collapsed'}"
				type="button" data-bs-toggle="collapse" data-bs-target="#ch07"
				aria-expanded="${chNum=='ch07'}" aria-controls="ch07">
				Ch07. Controller (Data Delivery)</button>
		</h2>
		<div id="ch07"
			...
			<div class="accordion-body">
				<ul>
					<li><a
						href="${pageContext.request.contextPath}/ch07/objectScope1">데이터(객체)
							사용 범위</a></li>
					<li><a
						href="${pageContext.request.contextPath}/ch07/objectScope2">데이터(객체)
							사용 범위</a></li>
				</ul>
			</div>
		</div>
	...
	<div class="accordion-item">
		<h2 class="accordion-header">
			<button class="accordion-button ${chNum=='ch08'?'':'collapsed'}"
				type="button" data-bs-toggle="collapse" data-bs-target="#ch08"
				aria-expanded="${chNum=='ch08'}" aria-controls="ch08">
				Ch08. Controller (Session Support) 세션 지원 API</button>
		</h2>
		<div id="ch08"
			...
			<div class="accordion-body">
				<ul>
					<li><a href="${pageContext.request.contextPath}/ch08/login">로그인
							폼</a></li>
					<!-- a태그로 요청하는 것은 get 방식 -->
					<li><a
						href="${pageContext.request.contextPath}/ch08/loginInfo">로그인
							정보</a></li>
	...
	<div class="accordion-item">
		<h2 class="accordion-header">
			<button class="accordion-button ${chNum=='ch09'?'':'collapsed'}"
				type="button" data-bs-toggle="collapse" data-bs-target="#ch09"
				aria-expanded="${chNum=='ch09'}" aria-controls="ch09">
				Ch09. 파일 업로드와 다운로드</button>
		</h2>
		<div id="ch09"
	...
	<div class="accordion-item">
		<h2 class="accordion-header">
			<button class="accordion-button ${chNum=='ch10'?'':'collapsed'}"
				type="button" data-bs-toggle="collapse" data-bs-target="#ch10"
				...
				<ul>
					<li><a
						href="${pageContext.request.contextPath}/ch10/handlingException1">try-catch
							이용</a></li>
					<li><a
						href="${pageContext.request.contextPath}/ch10/handlingException2">@ExceptionHandler
							이용</a></li>
					<li><a
						href="${pageContext.request.contextPath}/ch10/handlingException3">사용자
							정의 예외 처리</a></li>
					<li><a
						href="${pageContext.request.contextPath}/ch10/handlingException4">기타
							500 예외 처리</a></li>
					<li><a
						href="${pageContext.request.contextPath}/ch10/aaaaaaaaaaaaaaaaaa">404
							처리</a></li>
	...
	<div class="accordion-item">
		<h2 class="accordion-header">
			<button class="accordion-button ${chNum=='ch11'?'':'collapsed'}"
				type="button" data-bs-toggle="collapse" data-bs-target="#ch11"
		...
		<div id="ch11"
			...
			<div class="accordion-body">
				<ul>
					<li><a href="${pageContext.request.contextPath}/ch11/joinForm">다국어
							처리 된 회원가입폼</a></li>
	...
	<div class="accordion-item">
		<h2 class="accordion-header">
			<button class="accordion-button ${chNum=='ch12'?'':'collapsed'}"
				type="button" data-bs-toggle="collapse" data-bs-target="#ch12"
				aria-expanded="${chNum=='ch12'}" aria-controls="ch12">
				Ch12. 의존성 주입</button>
		</h2>
		<div id="ch12"
			class="accordion-collapse collapse ${chNum=='ch12'?'show':''}"
			data-bs-parent="#accordionMenu">
			<div class="accordion-body">
				<ul>
					<li><a href="${pageContext.request.contextPath}/ch12/createBeanByXml">XML 설정으로 관리 빈 설정</a></li>
	...
	<div class="accordion-item">
		<h2 class="accordion-header">
			<button class="accordion-button ${chNum=='ch13'?'':'collapsed'}"
				type="button" data-bs-toggle="collapse" data-bs-target="#ch13"
				aria-expanded="${chNum=='ch13'}" aria-controls="ch13">
				Ch13. 데이터베이스 연동</button>
		</h2>
		<div id="ch13"
	...
	<div class="accordion-item">
		<h2 class="accordion-header">
			<button class="accordion-button ${chNum=='ch15'?'':'collapsed'}"
				type="button" data-bs-toggle="collapse" data-bs-target="#ch15"
				aria-expanded="${chNum=='ch15'}" aria-controls="ch15">
				Ch15. Transaction 처리</button>
		</h2>
		<div id="ch15"
	...
	<div class="accordion-item">
		<h2 class="accordion-header">
			<button class="accordion-button ${chNum=='ch17'?'':'collapsed'}"
				type="button" data-bs-toggle="collapse" data-bs-target="#ch17"
				aria-expanded="${chNum=='ch17'}" aria-controls="ch17">
				Ch17. 스프링 시큐리티</button>
		</h2>
		<div id="ch17"
